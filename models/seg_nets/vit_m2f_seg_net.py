...
import sys
sys.path.append("../")
from models.seg_nets.get_dino_from_repo import get_repo_dino
from models.seg_nets.base_seg_net import BaseSegNet
from utils.m2f_utils import semantic_inference
from models.seg_nets.setr_decode_head import SETRUPHead_M2F
from models.seg_nets.mask2former import MultiScaleMaskedTransformerDecoder
...
class ViT_M2F_SegNet(BaseSegNet):
    ...
    Decoder based on: https://github.com/facebookresearch/Mask2Former
    ...
    def __init__(self, device, opt, num_known_classes):
        ...
        vit_dino = get_repo_dino(
                            ...
                            vit_type=self.opt.vit_type,
                            mlp_dropout_prob=self.opt.mlp_dropout_prob,
                            attn_dropout_prob=self.opt.attn_dropout_prob,
                            )
        ...
        from models.seg_nets.projection_networks import ProjectionMLP
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        return self.get_seg_masks(x, high_res=True)
